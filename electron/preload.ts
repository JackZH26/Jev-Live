...
names.push('hostSnapshot','saveHostConfig','saveHostLayouts','saveHostKey','importAvatar','importVoiceReference','startHost','stopHost','testHostVoice','applyHostLayout','gamePreview','preflight');
