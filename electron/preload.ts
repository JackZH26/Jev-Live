...
names.push('hostSnapshot','copyGameAnnouncement','saveHostConfig','saveHostLayouts','saveHostKey','importAvatar','importVoiceReference','startHost','stopHost','testHostVoice','applyHostLayout','gamePreview','preflight');
