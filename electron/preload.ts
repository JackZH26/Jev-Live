...
names.push('hostSnapshot','saveHostConfig','saveHostLayouts','saveHostKey','importAvatar','startHost','stopHost','testHostVoice','applyHostLayout','gamePreview','preflight');
