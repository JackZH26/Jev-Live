...
// Overlay polling replaces the avatar object even when its asset is unchanged.
// Compare each source value, not a fresh array, so state updates keep the rig alive.
