...
| Core/security tests | 31 passed: OAuth, refresh, handover, single/dual-output recovery, empty platform selection, YouTube activation errors, historical secret scan, Steam manifests and five-language resources |
