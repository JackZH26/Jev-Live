...
export const hostConfigSchema=z.object({
 ...
 gameContent:z.object({introductions:z.boolean().default(true),wishlist:z.boolean().default(true),introIntervalSec:z.number().int().min(90).max(1800).default(180),wishlistIntervalSec:z.number().int().min(300).max(3600).default(600)}).default(()=>({introductions:true,wishlist:true,introIntervalSec:180,wishlistIntervalSec:600})),
