...
export interface OverlayState{gameConnected?:boolean;layout:Layout;avatar:HostConfig['avatar'];messages:ChatMessage[];utterance:Utterance|null;provider:Provider;language:HostConfig['language']}
