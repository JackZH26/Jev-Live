...
**状态：0.1.2 开发预览。** 本轮完善自动主持、故障恢复和开播检查，提供私密 X 验收入口与 Windows 安装包构建。自然语音、真实平台聊天及长时直播尚有待验收项目，详见[本轮记录](docs/ITERATION_012.md)。ETC 专用自动玩独立开发，需兼容的游戏版本；不宣称电竞水平、每局必胜或 24 小时验收。其他游戏仍可手动游玩和采集直播。
