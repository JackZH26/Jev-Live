...
**状态：0.1.0 开发预览。** 当前重点是 **ETC 专用自动玩**：游戏原生接口、本地实时战术与可选 JEV 建议，独立于直播。接口已实现，须随游戏版本发布后才能完成 Steam 对局验收；暂不开发通用游戏自动玩，不宣称电竞水平、每局必胜或 24 小时验收。其他游戏仍可手动游玩和采集直播。
...
| OBS 输出 | YouTube / Twitch / X 任意组合；独立游戏与进程音频采集，前两路 1080p60，X 1080p30 |
